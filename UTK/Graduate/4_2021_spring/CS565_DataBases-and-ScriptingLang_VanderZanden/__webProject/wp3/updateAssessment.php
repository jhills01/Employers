<?php
    ...
    if (setAndNotEmptyStr($_GET["assessmentId"], "assessmentId")) {$assessmentId = $_GET["assessmentId"];}
    if (setAndNotEmptyStr($_GET["sectionId"], "sectionId")) {$sectionId = $_GET["sectionId"];}
    if (setAndNotEmptyStr($_GET["assessmentDescription"], "assessmentDescription")) {$assessmentDescription = $_GET["assessmentDescription"];} 
    if (setAndNotEmptyStr($_GET["weight"], "weight")) {$weight = $_GET["weight"];}
