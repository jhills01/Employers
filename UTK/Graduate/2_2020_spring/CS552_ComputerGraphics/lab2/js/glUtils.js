...
function setMatrixUniforms(gContext) {
    ...
    var camUniform = gl.getUniformLocation(gContext.shaderProgram, "camPos");
    gl.uniform3fv(camUniform, gContext.camPos); 
}
...
//
// similar to glTransform (NOTE: I think this is "glTranslate"), only affects modelViewMatrix 
//
